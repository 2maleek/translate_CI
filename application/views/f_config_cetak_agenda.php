<div class="panel panel-info">
	<div class="panel-heading">
		<h3 style="margin-top: 5px">Cetak Agenda</h3>
	</div>
</div>

<div class="well">
	<form action="<?php echo base_URL(); ?>surat/cetak_agenda" target="blank" method="post" accept-charset="utf-8"
		...
		<table class="table-form" width="100%">
			...
			<tr>
				<td colspan="2">
					<br>
				<button type="submit" class="btn btn-primary"><i class="icon icon-print icon-white"></i>
						Cetak</button>
					<a href="<?php echo base_URL(); ?>surat" class="btn btn-success"><i
